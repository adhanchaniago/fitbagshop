var EcommerceProductsEdit = function () { 
    ...
    function loadimagestmpData(){
        var dataString = 'loadType=1';
        $.ajax({
            type: "POST",
            url: imagesajaxhandler,
            data: dataString,
            cache: false,
            success: function(result){ 
                $("#result_images_handler").html('');  
                $("#result_images_handler").append(result);  
            }
        });
    }
    ...
    var handleReviews = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": define_folder, // ajax source
                    "data": function ( d ) {
                        d.statue = $('#product_review_status').val();
