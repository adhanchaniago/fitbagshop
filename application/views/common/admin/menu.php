                                ...
                                <ul class="dropdown-menu pull-left">
                                    <li class=" ">
                                        <a href="<?php echo admin_url(); ?>" class="nav-link  ">
                                            <i class="icon-bar-chart"></i> Beranda
                                            <span class="badge badge-success">1</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo admin_url(); ?>office" class="nav-link  ">
                                            <i class="icon-bulb"></i> Office Detail </a>
                                    </li>
                                    <li>
...
" class="nav-link  ">
                                            <i class="icon-bulb"></i> Filemanager </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo admin_url(); ?>user/profile/<?php echo $this->session->userdata('user_id'); ?>" class="nav-link  active">
                                            <i class="icon-bulb"></i> My Profile </a>
                                    </li>
                                    <li class=" ">
                                        <a href="<?php echo base_url(); ?>logout" class="nav-link  ">
                                            <i class="icon-graph"></i> Log out
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                            ...
                                            <div class="row">
                                                ...
                                                <h3>Produk</h3>
                                                    <ul class="mega-menu-submenu">
                                                        <li>
                                                            <a href="ui_colors.html"> Tambah Baru </a>
                                                        </li>
                                                        <li>
                                                            <a href="ui_general.html"> Daftar Produk </a>
                                                        </li>
                                                        <li>
                                                            <a href="ui_buttons.html"> Pergerakan Produk </a>
                                                        </li>
                                                        <li>
                                                            <a href="ui_confirmations.html"> Produk Masuk </a>
                                                        </li>
                                                        <li>
                                                            <a href="ui_icons.html"> Produk Keluar </a>
                                                        </li>
                                                        <li>
                                                            <a href="ui_socicons.html"> Produk Retur </a>
                                                        </li>
                                                        <li>
